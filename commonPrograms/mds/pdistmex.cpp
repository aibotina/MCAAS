...
/* $Revision: 1.1.6.2 $  $Date: 2004/12/24 20:47:07 $ */
...
/* Euclidean distance */
template<class T>
void eucdist(T *x, int m, int n, T *d)
{
    /*
...
template<class T>
void seudist(T *x, int m, int n, T *arg, T *d)
{
    /*
...
/* City Block Distance */
template<class T>
void citdist(T *x, int m, int n, T *d)
{
    /*
...
template<class T>
void mahdist(T *x, int m, int n, T *arg, T *d)
{
    /*
     Y = XI - XJ;
...
/* Minkowski distance */
template<class T>
void mindist(T *x, int m, int n, T arg, T *d)
{
    /*
...
template<class T>
void coscordist(T *x, int m, int n, T *d)
{
    /*
...
/* Hamming distance */
template<class T>
void hamdist(T *x, int m, int n, T *d)
{
    /*
...
/* Jaccard distance */
template<class T>
void jacdist(T *x, int m, int n, T *d)
{
    /*
     nz = XI ~= 0 | XJ ~= 0;
     ne = XI ~= XJ;
...
/* Chebychev distance */
template<class T>
void chedist(T *x, int m, int n, T *d)
{
    /*
     d = max(abs(XI-XJ),[],2);
     */
