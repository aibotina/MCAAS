...
%   $Revision: 1.1.6.6 $ $Date: 2004/07/28 04:38:37 $
...
function [Y,stress,iter,disparities] = MDS(Y,dissimilarities,weights,stressFun,metric,weighted,options)
